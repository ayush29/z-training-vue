                ...
                <div class="review-stars">
                    <div class="review-star" v-for="val in 5" :key="val">
                        <i size="16" color="#CFCFCF"><svg xmlns="http://www.w3.org/2000/svg" :style="{fill: val > rev.rating ? '#CFCFCF': '#1C1C1C'}"
                                ...
                                class="rev-star-svg">
                                <linearGradient :id="'rev_star' + rev.id + val" x1="0" x2="100%" y1="0" y2="0">
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    :style="{fill: 'url(\'#rev_star\'' + rev.id + val + ')'}"></path>
                            </svg></i>
                    </div>
                </div>
        ...
        <div class="cta">
            <div class="lcs" @click='likeReview'>
                <i class="lcs-symbol" size="16" color="#828282">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#828282" width="16" height="16"
                        ...
                        <linearGradient :id="'like_sym_svg' + rev.id" x1="0" x2="100%" y1="0" y2="0">
                        ...
                        <path
                            ...
                            :style="{fill: 'url(\'#like_sym_svg\'' + rev.id + ')'}"></path>
                    </svg></i>
            ...
            <div class="lcs comment-btn" @click="toggleCommentSection">
                <i class="lcs-symbol" size="16" color="#828282">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#828282" width="16" height="16"
                        ...
                        <linearGradient :id="'comment_sym_svg' + rev.id" x1="0" x2="100%" y1="0" y2="0">
                            <stop offset="0" stop-color="#828282"></stop>
                            <stop offset="100%" stop-color="#828282"></stop>
                        </linearGradient>
                        ...
                        <path
                            ...
                            :style="{fill: 'url(\'#comment_sym_svg\'' + rev.id + ')'}"></path>
                    </svg></i>
            ...
            <div class="lcs">
                <i class="lcs-symbol" size="16" color="#828282"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        class="lcs-symbol-svg">
                        <linearGradient :id="'share_sym_svg' + rev.id" x1="0" x2="100%" y1="0" y2="0">
                            <stop offset="0" stop-color="#828282"></stop>
                            <stop offset="100%" stop-color="#828282"></stop>
                        </linearGradient>
                        ...
                        <path
                            ...
                            :style="{fill: 'url(\'#share_sym_svg\'' + rev.id + ')'}"></path>
                    </svg></i>
