        ...
        <div class="rating-container">
            ...
            <div class="rating">
                <div class="rating-stars">
                    <i v-for="ind in 5" :key="ind"
                    size="28" color="#CFCFCF" data-darkreader-inline-color=""
                        style="--darkreader-inline-color:#e8e2d9;">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#CFCFCF" width="28" height="28"
                            viewBox="0 0 20 20" aria-labelledby="icon-svg-title-StarEmpty icon-svg-desc-StarEmpty"
                            role="img" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#e8e2d9;">
                    ...
                    <i size="28" color="#CFCFCF" data-darkreader-inline-color=""
                        style="--darkreader-inline-color:#e8e2d9;">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#CFCFCF" width="28" height="28"
                            viewBox="0 0 20 20" aria-labelledby="icon-svg-title-StarEmpty icon-svg-desc-StarEmpty"
                            role="img" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#e8e2d9;">
                            <linearGradient id="temp" x1="0" x2="100%" y1="0" y2="0">
                                <stop offset="0" stop-color="#CFCFCF"></stop>
                                <stop offset="100%" stop-color="#CFCFCF"></stop>
                            </linearGradient>
                            <title id="icon-svg-title-StarEmpty">Star Empty icon</title>
                ...
                <button disabled id="clear-rating-button"><span>Clear</span></button>
            </div>
            <a href="#" id="write-review"><span>Write a review</span></a>
        </div>
    </section>
</template>
